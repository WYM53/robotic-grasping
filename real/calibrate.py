...
checkerboard_offset_from_tool = [0,0.121,0] # 标定板到末端的距离
tool_orientation = [-np.pi/2,0,0] # 工具方向，需要让摄像头能看到 
#---------------------------------------------
...
# Move robot to home pose
print('Connecting to robot...')
robot = Ur5e_Robot(tcp_host_ip, tcp_port, is_use_robotiq85=False)
