...
class Ur5e_Robot:
    def __init__(self, tcp_host_ip="192.168.1.12", tcp_port=50002, is_use_robotiq85=True, is_use_camera=True):
        ...
        rtde_r = RTDEReceive(tcp_host_ip, rtde_frequency, [], True, False, rt_receive_priority)
        rtde_c = RTDEControl(tcp_host_ip, rtde_frequency, flags, tcp_port, rt_control_priority)
    ...
    def __init__(self, tcp_host_ip="192.168.1.12", tcp_port=30003, workspace_limits=None,
